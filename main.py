...
from company_alias_grouper import get_company_alias_groups
...
def main():
    ...
    classify_all_original_records.multipro_add_group_id(
        ['contracts_prime_transactions_%d.csv' % d for d in range(1, 6)], final_csv_file='final.csv')
    # write_2_db.copy_from_csv_to_db('final.csv')
