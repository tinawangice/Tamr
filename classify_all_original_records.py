...
from company_alias_grouper import AliasGroupFinder
...
def run():
    ...
    multipro_add_group_id(['contracts_prime_transactions_%d.csv' % d for d in range(1, 6)],
                          final_csv_file='data_with_group_id.csv')
